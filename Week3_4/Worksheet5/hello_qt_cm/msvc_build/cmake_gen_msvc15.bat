...
set OLD_PATH=%PATH%
set PATH=D:\cmake-3.19.0-rc1-win64-x64\bin;D:\Qt\5.15.1\msvc2019_64\bin
...
cmake -DCMAKE_PREFIX_PATH=D:\Qt\5.15.1\msvc2019_64\bin -G"Visual Studio 16 2019" %1
REM Restore old path (otherwise vcvarsall will fail) but make sure Qt bin dir has been added to it
set PATH=%OLD_PATH%;D:\Qt\5.15.1\msvc2019_64\bin
